...
for i = 1 : 10
    ...
    save(sprintf('E:/HastiShabani/2. Projects/0. PairwiseRegistration/Codes/Intensity_based/Run_3_Shading/NCC/Results_NCC/%d.mat',i),"rmse_north", "rmse_west", "average_rmse", "time_north", "time_west", "average_time","Tx_north", "Tx_west", "Ty_north", "Ty_west");
end
