function [RMSE_north, RMSE_west, average_RMSE, time_north, time_west, average_time, Tx_north, Tx_west, Ty_north, Ty_west] = pairwise_registration_NCC(direc, imtype, nEnd, htile, vtile, OL, dataset)
...
Tx_north =  zeros(nb_vert_tiles,nb_horz_tiles);
Ty_north =  zeros(nb_vert_tiles,nb_horz_tiles);

Tx_west =  zeros(nb_vert_tiles,nb_horz_tiles);
Ty_west =  zeros(nb_vert_tiles,nb_horz_tiles);
 ...
 fprintf('  col: %d  / %d\n', j ,nb_horz_tiles);
    for i = 1:nb_vert_tiles
        ...
        if i > 1
            ...
            t1 = tic;
            rect_I1 = [0 0 N M*OverlapY ];
            sub_I1 = imcrop(I1,rect_I1);
            c = normxcorr2(sub_I1,I2);
            ...
            Ty_north(i,j) = ypeak_north(i,j)-size(sub_I1,1);
